...
typedef VkResult(VKAPI_PTR *PFN_vkGetMemoryWin32HandleKHR)(VkDevice device, 
                 ...
                 HANDLE* pHandle);
typedef VkResult(VKAPI_PTR *PFN_vkGetMemoryWin32HandlePropertiesKHR)(VkDevice device, 
                 VkExternalMemoryHandleTypeFlagBits handleType, 
                 HANDLE handle, 
...
typedef VkResult(VKAPI_PTR *PFN_vkImportSemaphoreWin32HandleKHR)(VkDevice device, 
